...
?>
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <h6 style="color:#DC143C">Elites :</h6>
      <select id="inputState" class="form-control-file border" name="Elites">
      ...
      if(isset($_POST["save"]))
      {
        ...
        $price = $_POST["PriceMeal"];
             ...
             $folder = "Images/Fruits/".$tm.$file_name;
             ...
             else
             {
                 ...
                 $query = "INSERT INTO `tbl_fruits` (Image_Path,Elites,ItemName,ItemPrice)
                 VALUES ('$folder','$Elites','$restaurant','$price')";
