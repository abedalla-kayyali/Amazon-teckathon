...
import com.example.ebsher.Reomte.IGoogleApi;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                destionation = txtsearch.getText().toString();
                destionation = destionation.replace(" ", "+");
                mapFragment.getMapAsync(com.example.ebsher.MapsActivity.this);
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final LatLng sydney = new LatLng(32.034193, 35.726702);
            ...
            mService.getDataFromGoogleApi(requestUrl)
                    .enqueue(new Callback<String>() {
                                    ...
                                    public void run() {
                                        ...
                                        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                                            ...
                                            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                                                ...
                                                marker.setRotation(getBearing(startPostion, newPos));
                                                mMap.moveCamera(CameraUpdateFactory.newCameraPosition(new CameraPosition.Builder()
                                                        .target(newPos)
                                                        .zoom(15.5f)
                                                        .build()));
                        ...
                        public void onFailure(Call<String> call, Throwable t) {
                            Toast.makeText(com.example.ebsher.MapsActivity.this, "" + t.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
        } catch (Exception e) {
            e.printStackTrace();
